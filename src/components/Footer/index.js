...
const logoUrls = {
  ...
  hackerrank: 'https://vectorwiki.com/images/gfcQJ__hackerrank.svg'
};
  ...
  return (
    <FooterContainer>
      <FooterWrapper>
        ...
        <SocialMediaIcons>
          <SocialMediaIcon href={Bio.X} target="_blank"><FaTwitter /></SocialMediaIcon>
        ...
        <Copyright>
          &copy; 2024 Varshith Popuri. All rights reserved.
        </Copyright>
      </FooterWrapper>
    </FooterContainer>
  );
