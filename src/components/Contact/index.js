...
const ContactButton = styled.input`
  ...
  text-align: center;
  background: hsla(45, 100%, 60%, 1);
background: linear-gradient(225deg, hsla(45, 100%, 60%, 1) 0%, hsla(35, 100%, 50%, 1) 100%);
background: -moz-linear-gradient(225deg, hsla(45, 100%, 60%, 1) 0%, hsla(35, 100%, 50%, 1) 100%);
background: -webkit-linear-gradient(225deg, hsla(45, 100%, 60%, 1) 0%, hsla(35, 100%, 50%, 1) 100%);
